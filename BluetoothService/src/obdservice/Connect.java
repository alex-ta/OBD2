...
public class Connect {
	/**
	 * @author Alex Diese Klasse kümmert sich um den Datenaustausch zwischen
	 *         Handy und Gerät. Sie verbirgt die Verbindung mit dem OBD2 Gerät.
	 *         Dazu initialisiert Sie zuerst die OBD Protokolle über einer
	 *         Instanz der Klasse AutoInitObd2, dannach frägt Sie verschiedene
	 *         PIDS ab und schreibt Sie in eine Datenbank.
	 * 
	 *         stream ist die Bluetoothverbindung zum OBD Adapter send ist eine
	 *         Instanz des privaten Threads BgSend pidsupport hält die Anzahl
	 *         der unterstützen PIDs
	 * */
