...
public class AutoInitObd2 extends AsyncTask<BluetoothStream, Integer, Integer> {
	/**
	 * @author Alex Diese Klasse sorgt für die Initialisierung des ODB Adapters
	 *         mit dem ELM Protokoll. Dazu wird ELM über die AT Befehle wird das
	 *         ELM Protokoll zurückgesetzt, dannach werden die PIDS die benötigt
	 *         werden initialisiert. Die klasse hat einen BluetoothStream der
	 *         schon mit dem OBD Adapter verbunden ist. Die Klasse läuft als
	 *         Thread.
	 * */
