...
public class StartButton extends Activity {
	 ...
	 * beenden des Services kümmert diese Activity kann man in ein Optionsmenu
	 * einbauen. Die Activity überwacht zusätzlich den status der Verbindung
	...
	public void startobd(View v) {
		/**
		 * der Status des OBD Services wird überprüft, wenn der OBD service aus
		 * ist wird beim clicken die BluetoothActivity aufgerufen, die den
		 * status des Services zurückgibt. Falls der Service an ist wird er
	...
	private void obdon() {
		/** setzt die Werte wenn der Service läuft */
		state = true;
